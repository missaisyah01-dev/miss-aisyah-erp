...
type Transaction = { id: number; total: number; paid_amount: number; payment_status: "LUNAS" | "BELUM_LUNAS"; customer_name: string | null; payment_method: "CASH" | "QRIS" | "TRANSFER" | "PIUTANG"; created_at: string };
