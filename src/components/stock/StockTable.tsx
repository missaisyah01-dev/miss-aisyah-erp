...
export default function StockTable({ refreshKey = 0 }: { refreshKey?: number }) {
  ...
  return <section className="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm">
    <div className="flex flex-col gap-3 border-b border-gray-100 p-5 sm:flex-row sm:items-center sm:justify-between"><div><h2 className="text-lg font-bold text-gray-900">Riwayat pergerakan stok</h2><p className="mt-1 text-sm text-gray-500">Catatan stok masuk, keluar, dan retur yang telah diproses.</p></div><div className="flex flex-wrap gap-3">
